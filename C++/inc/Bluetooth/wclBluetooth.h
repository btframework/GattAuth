...
namespace wclBluetooth
{
	...
	/// <exclude />
	#define WCL_BLUETOOTH_LE_DEFAULT_SCAN_INTERVAL	200
	/// <exclude />
	#define WCL_BLUETOOTH_LE_DEFAULT_SCAN_WINDOW	50

	/// <exclude />
	#define WCL_BLUETOOTH_LE_COEX_SCAN_INTERVAL		588
	/// <exclude />
	#define WCL_BLUETOOTH_LE_COEX_SCAN_WINDOW		60

	/// <exclude />
	#define WCL_BLUETOOTH_LE_LOW_SCAN_INTERVAL		189
	/// <exclude />
	#define WCL_BLUETOOTH_LE_LOW_SCAN_WINDOW		29
	...
	/// <summary> A Bluetooth LE scan parameters types. </summary>
	typedef enum
	{
		/// <summary> A system default scan parameters. </summary>
		ptDefault,
		/// <summary> A coexistence optimized scan parameters. </summary>
		ptCoexistenceOptimized,
		/// <summary> A low latency scan parameters. </summary>
		ptLowLatency,
		/// <summary> A custom scan parameters. </summary>
		ptCustom
	} wclBluetoothLeScanParametersType;
	...
	private:
		...
		unsigned short		FReliableWriteHandle;
	...
	protected:
		...
		/* HAL reliable write support. */
		
		/// <summary> Implements a hardware-dependent code to specify the end of
		///   reliable write procedures, and the writes should be
		///   aborted. </summary>
		/// <returns> If the function succeed the return value is
		///   <see cref="WCL_E_SUCCESS" />. Otherwise the method returns one of
		///   the WCL error codes. </returns>
		/// <remarks> A derived class must override this method. </remarks>
		virtual int HalAbortReliableWrite() = 0;
		/// <summary> Implements a hardware-dependent code to specify that reliable
		///   writes are about to begin. </summary>
		/// <param name="Characteristic"> A <see cref="wclGattCharacteristic" />
		///   structure obtained by previous call to the <c>ReadCaracteristics</c>
		///   method. </param>
		/// <returns> If the function succeed the return value is
		...
		/// <remarks> A derived class must override this method. </remarks>
		/// <seealso cref="wclGattCharacteristic" />
		virtual int HalBeginReliableWrite(const wclGattCharacteristic& Characteristic) = 0;
		/// <summary> Implements a hardware-dependent code to specify the end of
		///   reliable writes, and the writes should be committed. </summary>
		/// <returns> If the function succeed the return value is
		///   <see cref="WCL_E_SUCCESS" />. Otherwise the method returns one of
		///   the WCL error codes. </returns>
		/// <remarks> A derived class must override this method. </remarks>
		virtual int HalEndReliableWrite() = 0;
	...
	public:
		...
		int WriteDescriptorValue(const wclGattDescriptor& Descriptor,
			const wclGattProtectionLevel Protection, const wclGattDescriptorValue& Value);

		/// <summary> The method specifies the end of reliable write procedures, and
		///   the writes should be aborted. </summary>
		/// <returns> If the function succeed the return value is
		///   <see cref="WCL_E_SUCCESS" />. Otherwise the method returns one of
		///   the WCL error codes. </returns>
		int AbortReliableWrite();
		/// <summary> The method specifies that reliable writes are about to
		///   begin. </summary>
		/// <param name="Characteristic"> A <see cref="wclGattCharacteristic" />
		///   structure obtained by previous call to the <c>ReadCaracteristics</c>
		///   method. </param>
		...
		///   the WCL error codes. </returns>
		/// <seealso cref="wclGattCharacteristic" />
		int BeginReliableWrite(const wclGattCharacteristic& Characteristic);
		/// <summary> The method specifies the end of reliable writes, and the
		///   writes should be committed. </summary>
		/// <returns> If the function succeed the return value is
		///   <see cref="WCL_E_SUCCESS" />. Otherwise the method returns one of
		///   the WCL error codes. </returns>
		int EndReliableWrite();
		...
		/// <summary> Gets a reliable write operation status. </summary>
		/// <returns> <c>True</c> when a reliable write operation was started and is
		///   still active. <c>False</c> otherwise. </returns>
		bool GetReliableWriteActive() const;
		/// <summary> Gets a reliable write operation status. </summary>
		/// <value> <c>True</c> when a reliable write operation was started and is
		///   still active. <c>False</c> otherwise. </value>
		__declspec(property(get = GetReliableWriteActive)) bool ReliableWriteActive;
	...
	protected:
		...
		/// <returns> The critical section object. </returns>
	...
	private:
		...
		wclBluetoothLeScanParametersType	FScanParametersType;
		unsigned short						FScanInterval;
		unsigned short						FScanWindow;

		void ResetScanParameters();
	...
	protected:
		...
		/// <summary> The method converts the scan parameters type to the
		///   scan parameters: scan interval and scan window. </summary>
		/// <param name="Interval"> On output contains the scan interval for
		///   the selected scan parameters type. </param>
		/// <param name="Window"> On output contains the scan window for
		///   the selected scan parameters type. </param>
		void GetScanParamValues(unsigned short& Interval, unsigned short& Window);
	...
	public:
		...
		///   mode. </param>
		/// <param name="ScanParametersType"> Specifies the Bluetooth LE scan
		///   parameters type. </param>
		/// <param name="ScanInterval"> Specifies the Bluetooth LE scan in
		///   <c>0.625ms</c> units. The value must be in range between <c>4</c> and
		///   <c>16384</c>. </param>
		/// <param name="ScanWindow"> Specifies the Bluetooth LE scan window in
		///   <c>0.625ms</c> units. The value must be in range between <c>4</c> and
		///   <c>16384</c>. The scan window must be less or equal to
		///   the <c>ScanInterval</c>. </param>
		/// <returns> If the function succeed the return value is
		///   <see cref="WCL_E_SUCCESS" />. Otherwise the method returns one of
		///   the WCL error codes. </returns>
		/// <seealso cref="wclBluetoothLeScanningMode" />
		/// <seealso cref="wclBluetoothLeScanParametersType" />
		int Start(const bool AllowExtendedAdvertisements,
			const wclBluetoothLeScanningMode ScanningMode,
			const wclBluetoothLeScanParametersType ScanParametersType,
		...
		/// <summary> Gets the scan parameters type used by the watcher. </summary>
		/// <returns> A scan parameters type. </returns>
		/// <seealso cref="wclBluetoothLeScanParametersType" />
		wclBluetoothLeScanParametersType GetScanParametersType() const;
		/// <summary> Gets the scan parameters type used by the watcher. </summary>
		/// <value> A scan parameters type. </value>
		/// <seealso cref="wclBluetoothLeScanParametersType" />
		__declspec(property(get = GetScanParametersType)) wclBluetoothLeScanParametersType ScanParametersType;
	...
	public:
		...
		/// <param name="PrimaryPhy"> Specifies a primary advertisement PHY. </param>
		/// <param name="SecondaryPhy"> Specifies a secondary advertisement PHY. </param>
		/// <returns> If the function succeed the return value is
		///   <see cref="WCL_E_SUCCESS" />. Otherwise the method returns one of
		///   the WCL error codes. </returns>
		...
		/// <summary> Gets a primary advertisement PHY. </summary>
		/// <returns> The advertisement PHY. </returns>
		/// <seealso cref="wclBluetoothLeAdvertisementPhy" />
		wclBluetoothLeAdvertisementPhy GetPrimaryPhy() const;
		/// <summary> Gets a primary advertisement PHY. </summary>
		/// <value> The advertisement PHY. </value>
		/// <seealso cref="wclBluetoothLeAdvertisementPhy" />
		__declspec(property(get = GetPrimaryPhy)) wclBluetoothLeAdvertisementPhy PrimaryPhy;
		
		/// <summary> Gets a secondary advertisement PHY. </summary>
		/// <returns> The advertisement PHY. </returns>
		/// <seealso cref="wclBluetoothLeAdvertisementPhy" />
	...
	public:
		...
		/// <summary> Gets a Bluetooth LE scan parameters type. </summary>
		/// <returns> A Bluetooth LE scan parameters type. </returns>
		/// <remarks> If the <c>ScanParametersType</c> set to <c>ptCustom</c> the
		///   <c>ScanInterval</c> and <c>ScanWindow</c> properties are used as the
		///   scan parameters. If the <c>ScanParametersType</c> set to any other
		///   value the <c>ScanInterval</c> and <c>ScanWindow</c> properties are
		///   ignored. </remarks>
		/// <seealso cref="wclBluetoothLeScanParametersType" />
		wclBluetoothLeScanParametersType GetScanParametersType() const;
		/// <summary> Sets a Bluetooth LE scan parameters type. </summary>
		/// <param name="Value"> A Bluetooth LE scan parameters type. </param>
		/// <remarks> If the <c>ScanParametersType</c> set to <c>ptCustom</c> the
		///   <c>ScanInterval</c> and <c>ScanWindow</c> properties are used as the
		///   scan parameters. If the <c>ScanParametersType</c> set to any other
		///   value the <c>ScanInterval</c> and <c>ScanWindow</c> properties are
		///   ignored. </remarks>
		/// <seealso cref="wclBluetoothLeScanParametersType" />
		void SetScanParametersType(const wclBluetoothLeScanParametersType Value);
		/// <summary> Gets and sets a Bluetooth LE scan parameters type. </summary>
		/// <value> A Bluetooth LE scan parameters type. </value>
		/// <remarks> If the <c>ScanParametersType</c> set to <c>ptCustom</c> the
		///   <c>ScanInterval</c> and <c>ScanWindow</c> properties are used as the
		///   scan parameters. If the <c>ScanParametersType</c> set to any other
		///   value the <c>ScanInterval</c> and <c>ScanWindow</c> properties are
		///   ignored. </remarks>
		/// <seealso cref="wclBluetoothLeScanParametersType" />
		__declspec(property(get = GetScanParametersType, put = SetScanParametersType))
			wclBluetoothLeScanParametersType ScanParametersType;
	...
	public:
		...
		/// <summary> Gets a primary advertismeent PHY. </summary>
		/// <returns> The advertisement PHY. </returns>
		/// <seealso cref="wclBluetoothLeAdvertisementPhy" />
		wclBluetoothLeAdvertisementPhy GetPrimaryPhy() const;
		/// <summary> Sets a primary advertismeent PHY. </summary>
		/// <param name="value"> The advertisement PHY. </param>
		/// <seealso cref="wclBluetoothLeAdvertisementPhy" />
		/// <exception cref="wclEBluetoothLeBeacon"></exception>
		void SetPrimaryPhy(const wclBluetoothLeAdvertisementPhy value);
		/// <summary> Gets and sets a primary advertismeent PHY. </summary>
		/// <value> The advertisement PHY. </value>
		/// <seealso cref="wclBluetoothLeAdvertisementPhy" />
		/// <exception cref="wclEBluetoothLeBeacon"></exception>
		__declspec(property(get = GetPrimaryPhy, put = SetPrimaryPhy)) wclBluetoothLeAdvertisementPhy PrimaryPhy;
		
		/// <summary> Gets a secondary advertismeent PHY. </summary>
		/// <returns> The advertisement PHY. </returns>
		/// <seealso cref="wclBluetoothLeAdvertisementPhy" />
		wclBluetoothLeAdvertisementPhy GetSecondaryPhy() const;
		/// <summary> Sets a secondary advertismeent PHY. </summary>
		/// <param name="value"> The advertisement PHY. </param>
		/// <seealso cref="wclBluetoothLeAdvertisementPhy" />
		/// <exception cref="wclEBluetoothLeBeacon"></exception>
		void SetSecondaryPhy(const wclBluetoothLeAdvertisementPhy value);
		/// <summary> Gets and sets a secondary advertismeent PHY. </summary>
		/// <value> The advertisement PHY. </value>
		/// <seealso cref="wclBluetoothLeAdvertisementPhy" />
		/// <exception cref="wclEBluetoothLeBeacon"></exception>
		__declspec(property(get = GetSecondaryPhy, put = SetSecondaryPhy)) wclBluetoothLeAdvertisementPhy SecondaryPhy;
