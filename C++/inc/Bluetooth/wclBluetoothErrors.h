...
namespace wclBluetooth
{
	...
	/// <summary> A Bluetooth hardware driver rejected the specified scan
	///   parameters. Use the default to start a Beacon Watcher. </summary>
	const int WCL_E_BLUETOOTH_LE_WATCHER_DRIVER_REJECTED_SCAN_PARAMS = WCL_E_BLUETOOTH_LE_BASE + 0x00E0;
	/// <summary> Changing Bluetooth LE advertisement PHY is not supported on this platform. </summary>
	const int WCL_E_BLUETOOTH_LE_ADVERTISEMENT_PHY_NOT_SUPPORTED = WCL_E_BLUETOOTH_LE_BASE + 0x00E1;
	/// <summary> The specified primary PHY is not supported by the BluetoothLeAdvertiser. </summary>
	const int WCL_E_BLUETOOTH_LE_ADVERTISEMENT_PRIMARY_PHY_NOT_SUPPORTED = WCL_E_BLUETOOTH_LE_BASE + 0x00E2;
	/// <summary> The specified secondary PHY is not supported by the BluetoothLeAdvertiser. </summary>
	const int WCL_E_BLUETOOTH_LE_ADVERTISEMENT_SECONDARY_PHY_NOT_SUPPORTED = WCL_E_BLUETOOTH_LE_BASE + 0x00E3;
	/// <summary> A reliable write operation is active. Complete the reliable write operation before
	///   calling this method. </summary>
	const int WCL_E_BLUETOOTH_LE_RELIABLE_WRITE_ACTIVE = WCL_E_BLUETOOTH_LE_BASE + 0x00E4;
	/// <summary> Incorrect write operation selected during writing a characteristic value. </summary>
	const int WCL_E_BLUETOOTH_LE_INVALID_WRITE_OPERATION = WCL_E_BLUETOOTH_LE_BASE + 0x00E5;
	/// <summary> A reliable write operation was started for other characteristic. </summary>
	const int WCL_E_BLUETOOTH_LE_RELIABLE_WRITE_WRONG_ATTRIBUTE = WCL_E_BLUETOOTH_LE_BASE + 0x00E6;
	/// <summary> A reliable write operation was not started. </summary>
	const int WCL_E_BLUETOOTH_LE_RELIABLE_WRITE_NOT_STARTED = WCL_E_BLUETOOTH_LE_BASE + 0x00E7;
	/// <summary> A reliable write operation has already been started. </summary>
